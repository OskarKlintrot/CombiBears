...
var PIXIStage = React.createClass({
  ...
  componentDidMount: function() {
    ...
    var transparent = props.transparent || true;
    var antialias = props.antialias || true;

    this._displayObject = new PIXI.Container();
    this._pixirenderer = PIXI.autoDetectRenderer(props.width, props.height, {view:renderelement, backgroundColor: backgroundcolor, transparent: transparent, antialias: antialias});
