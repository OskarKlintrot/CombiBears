const Swedish = {
  ...
  saveSofaSubtitle: 'Spara en soffa genom att trycka på Spara-knappen.',
  saveSofa: 'Det går bara att spara en soffa om alla nallar har placerats ut eller om soffan är full. Det går inte att spara samma soffa två gånger. Om du försöker spara en soffa som redan har sparats så markeras den redan sparade soffan i listan till höger med en röd bakgrund. Om du vill få en bättre överblick över de soffor du sparat kan du trycka på pilknappen, så kommer ett fönster upp med alla sparade soffor.',
  ...
  resultTitle: 'Se resultat',
  result: 'Om du trycker på knappen med en bock så ser du hur många och vilka soffor du har hittat och hur många soffor du har kvar att hitta.',
  solutionTitle: 'Se lösning',
  solution: 'Om du klickar på knappen med en pokal på så ser du de soffor som du inte har hittat.',
